    ...
    <div className="flex justify-center items-center z-50">
      ...
      {show && (
        <div className="modal-container transition-all ease-in-out ">
          ...
          ></div>
          <div className="fixed top-1/1 left-1/3 bg-zinc-900 md:w-[30%] md:h-[40%]   rounded-lg ">
            <XIcon
              onClick={() => setShow(false)}
            ...
            <div className="flex flex-col gap-4 p-6">
              ...
              <form className="flex flex-col gap-4 p-4">
                ...
                <Input required placeholder="Recipe app" />
                <label>Describe your project *</label>
                <Input required placeholder="Recipe app to track recipes" />
